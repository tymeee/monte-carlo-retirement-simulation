...
def explain_results(api_key,model,input_data,allocation_data,results_data):
  ...
  prompt = ( 
    "You are to act as a financial guide for individuals who have very little degree of finance basics. Your job is to explain to them why the results of their Monte Carlo came out the way it did."
