...
def explain_results(api_key,model,input_data,allocation_data,results_data):
  ...
  prompt = ( 
    ...
    "Focus too on withdrawal strategies and retirement outlooks, and take everything together, never seperate metrics out as that may lead to skewed interpretations. Analyze withdrawals a lot on effectiveness, if the withdrawals are low, this does not always equate to a good strategy, evaluate withdrawals with scrutiny as living costs are very high, point out withdrawals that are obviosuly low. DO NOT EVER put low withdrawals as a strenght."
    """ Lastly,
