...
with col1:
    household = thb_number_input(label = "ค่าใช้จ่ายเกี่ยวกับบ้าน", min_value = 0)
    bills = thb_number_input (label = "ค่าสาธารณูปโภค (ค่าไฟฟ้า, ค่าน้ำประปา, อื่น ๆ)" , min_value = 0)
    leisure = thb_number_input (label = "ค่าท่องเที่ยว/สันทนาการ", min_value = 0 )
    other = thb_number_input(label = "ค่าใช้จ่ายอื่น ๆ", min_value = 0)
with col2:
    Food_and_dining = thb_number_input (label = "ค่าใช้จ่ายเกี่ยวกับอาหาร", min_value = 0 )
    clothes = thb_number_input (label = "ค่าเสื้อผ้า เครื่องแต่งกาย", min_value = 0 )
    travel = thb_number_input (label = "ค่าเดินทาง", min_value = 0 )
    donate = thb_number_input(label = "ค่าบริจาค/ทำบูญ", min_value = 0 )
with col3:
    hospital = thb_number_input (label = "ค่าใช้จ่ายเกี่ยวกับสุขภาพ",min_value = 0 )
    rent = thb_number_input (label = "ค่าผ่อนบ้าน/ผ่อนรถ", min_value = 0)
    child = thb_number_input(label = "ค่าเลี้ยงลูกหลาน", min_value =0 )
