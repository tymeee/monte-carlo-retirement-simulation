...
response = client.chat.completions.create(
    messages=[
        {
            "role": "system",
            "content": "You are to gauge how much money would it cost (monthly and annually), to live. Try to make it so that inflation doesn't become that big of a factor, just calculate mainly expenses.  When breaking down expenses, make it extremely detailed (eg. instead of saying120k per year, also say where these things actually go and what you have to pay for) Living expenses and assumptions should be based on the lifestyle inputted by the user, the lifestyle is as follows." + prompt + "If any part of the inputted message is in Thai, respond in Thai.",
        }
    ],
